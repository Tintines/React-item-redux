...
class Header extends Component{
    ...
    getTitle = ()=>{
        ...
        /* 处理子路由路径末端携带参数的路径, 由于上一行代码只拿到了最后一个 参数,而导致 不能显示正确的 父级导航名称 */
        /* 通过判断路径中 有符合的特殊的 父级路径对应的参数  来正确显示当前的父级title */
        if (pathname.indexOf('product') !== -1) pathKey = 'product'         // 专门用来处理父级路径 为product 的子路由展示时显示父路由title的方法
